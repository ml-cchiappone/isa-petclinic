...
describe('Pets Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'pets', component: PetsComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to petsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPetsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPetsIdentifier).toHaveBeenCalledWith(entity);
