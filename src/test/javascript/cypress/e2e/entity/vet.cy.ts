...
describe('Vet e2e test', () => {
  ...
  const vetSample = { firstname: 'Actualizable invoice Metal', lastname: 'proyección sensor adaptador' };
  ...
  describe('new Vet page', () => {
    ...
    it('should create an instance of Vet', () => {
      cy.get(`[data-cy="firstname"]`).type('Chipre Plástico matrix').should('have.value', 'Chipre Plástico matrix');

      cy.get(`[data-cy="lastname"]`).type('Blanco Borders').should('have.value', 'Blanco Borders');
